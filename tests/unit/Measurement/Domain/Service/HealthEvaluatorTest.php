...
final class HealthEvaluatorTest extends TestCase
{
    ...
    private function completedMeasurement(
        ...
        $payload = [
            ...
            "download" => ["bandwidth" => intdiv($downloadBits, 8), "bytes" => 1_200_000_000, "elapsed" => 9_000, "latency" => ["iqm" => 18.4]],
            "upload" => ["bandwidth" => intdiv($uploadBits, 8), "bytes" => 240_000_000, "elapsed" => 8_000, "latency" => ["iqm" => 22.1]],
