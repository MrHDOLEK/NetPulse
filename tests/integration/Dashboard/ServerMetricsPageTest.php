...
final class ServerMetricsPageTest extends KernelTestCase
{
    ...
    private const string SERVER_NAME = "Acme Speedtest";
    ...
    public function testAuthenticatedServersPageRendersSsrShell(): void
    {
        $this->seedWorld();
        $this->login();
        ...
        self::assertStringContainsString('x-data="servers"', $body);

        self::assertStringContainsString('id="servers-table"', $body);

        self::assertStringContainsString('id="servers-bootstrap"', $body);

        self::assertStringContainsString(self::SERVER_NAME, $body);

        self::assertMatchesRegularExpression('/<a[^>]*href="\/servers"/', $body);
