...
final class SqlMeasurementListRepositoryTest extends KernelTestCase
{
    ...
    private function seed(): void
    {
        ...
        $this->insert(self::CONN_A, self::SERVER_WARSAW, "Warsaw", "completed", $start + 100, 900_000_000, 90_000_000, 12.0, 2.0, 0.00, true, true);
        $this->insert(self::CONN_A, self::SERVER_WARSAW, "Warsaw", "completed", $start + 200, 800_000_000, 80_000_000, 14.0, 3.0, 0.01, true, true);
        $this->insert(self::CONN_A, self::SERVER_WARSAW, "Warsaw", "completed", $start + 300, 700_000_000, 70_000_000, 16.0, 4.0, 0.00, false, true);

        $this->insert(self::CONN_A, self::SERVER_WARSAW, "Warsaw", "completed", $start + 400, 500_000_000, 50_000_000, 20.0, 5.0, 0.02, true, true);
        $this->insert(self::CONN_A, self::SERVER_WARSAW, "Warsaw", "completed", $start + 500, 500_000_000, 50_000_000, 22.0, 6.0, 0.02, true, true);

        $this->insert(self::CONN_A, self::SERVER_WARSAW, "Warsaw", "failed", $start + 600, null, null, null, null, null, null, false);

        $this->insert(self::CONN_A, self::SERVER_BERLIN, "Berlin", "completed", $start + 700, 300_000_000, 30_000_000, 60.0, 12.0, 0.08, false, false);

        $this->insert(self::CONN_B, self::SERVER_BERLIN, "Berlin", "completed", $start + 800, 600_000_000, 60_000_000, 18.0, 4.0, 0.01, true, true);
        $this->insert(self::CONN_B, self::SERVER_BERLIN, "Berlin", "completed", $start + 900, 650_000_000, 65_000_000, 19.0, 5.0, 0.00, true, true);

        $this->insert(self::CONN_B, self::SERVER_BERLIN, "Berlin", "failed", $start + 1000, null, null, null, null, null, null, true);

        $this->insert(self::CONN_B, self::SERVER_WARSAW, "Warsaw", "completed", $start + 1100, 400_000_000, 40_000_000, 70.0, 15.0, 0.09, false, false);
        $this->insert(self::CONN_B, self::SERVER_WARSAW, "Warsaw", "completed", $start + 1200, 420_000_000, 42_000_000, 24.0, 7.0, 0.01, true, false);

        $this->insert(self::CONN_A, self::SERVER_WARSAW, "Warsaw", "completed", $start - 50, 999_000_000, 99_000_000, 9.0, 1.0, 0.00, true, true);

        $this->insert(self::CONN_B, self::SERVER_BERLIN, "Berlin", "completed", $this->nowUnix, 999_000_000, 99_000_000, 9.0, 1.0, 0.00, true, true);
    }
