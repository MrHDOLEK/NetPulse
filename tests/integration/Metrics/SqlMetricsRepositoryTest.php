...
final class SqlMetricsRepositoryTest extends KernelTestCase
{
    ...
    private function seed(): void
    {
        ...
        $this->insertMeasurement("aaaaaaaa-0000-0000-0000-000000000001", $probeId, $connFresh, "completed", "2026-06-05 11:00:00", 900000000, 400000000, 11.0, 2.0, 0.0, 14.0, 17.0, 60000000, 40000000, true);
        $this->insertMeasurement("aaaaaaaa-0000-0000-0000-000000000002", $probeId, $connFresh, "completed", "2026-06-05 12:00:00", 950000000, 480000000, 12.0, 2.1, 0.0, 15.0, 18.0, 100000000, 23456789, true);

        $this->insertMeasurement("aaaaaaaa-0000-0000-0000-000000000003", $probeId, $connFresh, "failed", "2026-06-05 11:30:00", null, null, null, null, null, null, null, null, null, null);

        $this->insertMeasurement("bbbbbbbb-0000-0000-0000-000000000001", $probeId, $connStale, "completed", "2019-12-31 23:00:00", 100000000, 50000000, 30.0, 5.0, 0.01, 40.0, 45.0, 30000000, 20000000, false);
        $this->insertMeasurement("bbbbbbbb-0000-0000-0000-000000000002", $probeId, $connStale, "completed", "2020-01-01 00:00:00", 100000000, 50000000, 30.0, 5.0, 0.01, 40.0, 45.0, 30000000, 20000000, false);
