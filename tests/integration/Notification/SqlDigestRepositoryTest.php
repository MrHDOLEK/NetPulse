...
final class SqlDigestRepositoryTest extends KernelTestCase
{
    ...
    private function seed(): void
    {
        ...
        $this->insertMeasurement("a0000000-0000-0000-0000-000000000000", self::CONN_A, "completed", "2026-06-05 09:00:00", 999_000_000, 99_000_000, 99.0, 0.99, true);

        $this->insertMeasurement("a0000000-0000-0000-0000-000000000001", self::CONN_A, "completed", "2026-06-05 13:00:00", 100_000_000, 10_000_000, 10.0, 0.0, true);
        $this->insertMeasurement("a0000000-0000-0000-0000-000000000002", self::CONN_A, "completed", "2026-06-05 14:00:00", 200_000_000, 20_000_000, 20.0, 0.02, true);
        $this->insertMeasurement("a0000000-0000-0000-0000-000000000003", self::CONN_A, "completed", "2026-06-05 15:00:00", 300_000_000, 30_000_000, 30.0, 0.04, false);
        $this->insertMeasurement("a0000000-0000-0000-0000-000000000004", self::CONN_A, "failed", "2026-06-05 16:00:00", null, null, null, null, null);

        $this->insertMeasurement("b0000000-0000-0000-0000-000000000001", self::CONN_B, "completed", "2026-06-05 13:00:00", 500_000_000, 50_000_000, 5.0, 0.0, true);
    }
