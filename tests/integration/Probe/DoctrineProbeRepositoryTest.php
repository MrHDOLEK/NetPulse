...
final class DoctrineProbeRepositoryTest extends KernelTestCase
{
    ...
    public function testSavesAndGetsProbeRoundTrip(): void
    {
        ...
        $this->assertEquals(new DateTimeImmutable('2026-06-05T10:00:00+00:00'), $loaded->createdAt());
        $this->assertSame('UTC', $loaded->createdAt()->getTimezone()->getName());
        $this->assertSame('2026-06-05T10:00:00+00:00', $loaded->createdAt()->format("Y-m-d\TH:i:sP"));
    }

    public function testFindReturnsNullForUnknownProbe(): void
    {
        $this->assertNull($this->repository->find(new ProbeId('11111111-1111-1111-1111-111111111111')));
    }
