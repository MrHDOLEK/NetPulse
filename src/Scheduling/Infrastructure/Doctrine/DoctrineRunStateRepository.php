...
final readonly class DoctrineRunStateRepository implements RunStateRepository
{
    ...
    {
        $this->connection->executeStatement('INSERT INTO run_states (connection_id, phase, updated_at) '
    ...
    {
        $this->connection->executeStatement('UPDATE run_states SET phase = :phase, updated_at = :updatedAt WHERE connection_id = :connectionId', [
