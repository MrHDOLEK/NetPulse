...
final readonly class DoctrineDueNowMarkerRepository implements DueNowMarkerRepository
{
    ...
    {
        $this->connection->executeStatement('INSERT INTO due_now_markers (connection_id, requested_at, forced_server_id) '
    ...
    public function pullForProbe(ProbeId $probeId): MarkedConnectionCollection
    {
        return $this->connection->transactional(function (Connection $connection) use (
            ...
            return MarkedConnectionCollection::fromList(array_map(
