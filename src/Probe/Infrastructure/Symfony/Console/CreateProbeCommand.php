...
#[AsCommand(name: 'app:probe:create', description: 'Create a probe and print its one-time plaintext token.')]
final class CreateProbeCommand extends Command
{
    ...
    {
        $this->addArgument('name', InputArgument::REQUIRED, 'Human-readable probe name')->addOption(
            'label',
            null,
