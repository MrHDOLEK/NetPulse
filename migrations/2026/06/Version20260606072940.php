...
final class Version20260606072940 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE probes (name VARCHAR(255) NOT NULL, labels CLOB NOT NULL, token_hash VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, created_at DATETIME NOT NULL, id VARCHAR(36) NOT NULL, PRIMARY KEY (id))");
